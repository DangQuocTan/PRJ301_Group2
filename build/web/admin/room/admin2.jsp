    ...
    <header class="header" id="navigation-menu">
        <div class="container">
          <nav>
            ...
            <ul class="nav-menu">
              <li> <a href="http://localhost:9999/hotel/js/home" class="nav-link">Home</a> </li>
             ...
             <c:if test="${sessionScope.account==null}">
                        ...
                        <c:if test="${sessionScope.account!=null}">
                            ...
                            <a href="../../js/login.jsp" class="nav-link1" style="padding: 0.54rem; color: #C1B086; background-color: #fff;">Logout</a>
                     </c:if>
            </ul>
          </nav>
        </div>
