...
<html>
    ...
    <body>
            ...
            <div class="container3">
                <nav>
                    ...
                    <ul class="nav-menu" style="margin-right: 3rem;">
                        <li> <a href="http://localhost:9999/hotel/js/home#home" class="nav-link">Home</a> </li>
                        ...
                        <c:if test="${sessionScope.account.getUser()=='admin'}">
                            <li>
                                <a href="http://localhost:9999/hotel/admin/room/roomList" class="nav-link">Manager Page</a> 
                            </li>
                        </c:if>
                        <c:if test="${sessionScope.account!=null}">
        ...
        <section class="map top">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3515.7503263127023!2d105.51934094267465!3d21.000339280443914!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31345b0206053f5f%3A0x2bb48a98e38fc06b!2zTmjDoCBUcuG7jSBUdeG6pW4gQ8aw4budbmc!5e0!3m2!1svi!2s!4v1657639323488!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </section>
        <footer>
