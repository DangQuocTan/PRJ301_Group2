            ...
            <div class="container3">
                <nav>
                    ...
                    <ul class="nav-menu" style="margin-right: 3rem;">
                        ...
                        <li> <a href="home#room" class="nav-link">Rooms</a> </li>
                        <li> <a href="home#restaurant" class="nav-link">Restaurant</a> </li>
                        <li> <a href="home#gallary" class="nav-link">Gallery</a> </li>
                        ...
                        <div class="container flex">
                            <div class="input grid">
                                <div class="box">
                                    ...
                                    <input type="date" name="checkin" placeholder="Check-in-Date" value="${checkin}" >
                                </div>
                                <div class="box">
                                    <label>Check-out:</label>
                                    <input type="date" name="checkout" placeholder="Check-out-Date" value="${checkout}" >
                                </div>
                                <div class="box">
                                    <label>Adults:</label>
                                    <input type="number" placeholder="0" id="adult" name="adult"  min="0" readonly="" value="${adult}" >
                                </div>
                                <div class="box">
                                    <label>Children:</label>
                                    <input type="number" placeholder="0" id="child" name="child"  min="0"  readonly="" value="${child}" >
                                </div>
                                <div class="box">
