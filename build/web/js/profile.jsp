                        ...
                        <div class="billing-details">
                            <form action="profile"  method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" value="${sessionScope.account.user}" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Password</label>
                                    <input type="text" class="form-control" name="pass" value="${sessionScope.account.pass}">
                                </div>

                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" class="form-control" name="email" value="${sessionScope.account.email}">
                                                                <input type="hidden" class="form-control" name="uID" value="${sessionScope.account.id}">
                                </div>
